...
typedef struct
{
  ...
  /**Peoplecontext**/
  PeopleContext_TypeDef* People_ContextPtr;   
}AppContext_TypeDef;
...
#define WELCOME_MSG_0            "People Counting"
#define WELCOME_MSG_1            "8-bit Quantized model"
#define WELCOME_MSG_2            "YoloLC uint8 240*240 float"
...
/*set it to 1 for full screen display or any other value for desactivation*/
#define FULLSCREENLCD 1
///*****************************/
///***Buffers size definition***/
///*****************************/
#define CAM_FRAME_BUFFER_SIZE (CAM_RES_WIDTH * CAM_RES_HEIGHT * RGB_565_BPP)

#define PIXEL_FORMAT_CONVERSION_BUFFER_SIZE (AI_NETWORK_WIDTH*AI_NETWORK_HEIGHT*RGB_888_BPP)
...
void APP_PpYoloLc(AppContext_TypeDef *);
