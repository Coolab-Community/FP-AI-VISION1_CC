...
*/
void Init_PeopleDataMemoryLayout(AppContext_TypeDef *App_Context_Ptr)
{  
 ...
 #define  RESIZE_OUTPUT_BUFFER_OFFSET (CAM_FRAME_BUFFER_SIZE - RESIZE_OUTPUT_BUFFER_SIZE) 
  ...
  App_Context_Ptr->People_ContextPtr->activation_buffer = ai_fp_global_memory;
   ...
   App_Context_Ptr->People_ContextPtr->nn_input_buffer = NULL;
  #else
   App_Context_Ptr->People_ContextPtr->nn_input_buffer = ai_fp_global_memory + AI_ACTIVATION_BUFFER_SIZE;
  #endif
  ...
  App_Context_Ptr->People_ContextPtr->activation_buffer = ai_fp_activation_memory;
  ...
  App_Context_Ptr->Preproc_ContextPtr->Resize_Dst_Img.pData = ai_fp_activation_memory + RESIZE_OUTPUT_BUFFER_OFFSET;
   ...
   App_Context_Ptr->People_ContextPtr->nn_input_buffer = NULL;
  #else
   App_Context_Ptr->People_ContextPtr->nn_input_buffer = ai_fp_global_memory + CAM_FRAME_BUFFER_SIZE;
  #endif
 #else /*MEMORY_SCHEME == FULL_EXTERNAL*/
  /*Offset so to "bottom" align camera_frame_buff buffer and resize_output_buff buffer*/
  #define  RESIZE_OUTPUT_BUFFER_OFFSET (CAM_FRAME_BUFFER_SIZE - RESIZE_OUTPUT_BUFFER_SIZE) 
  App_Context_Ptr->People_ContextPtr->activation_buffer  = ai_fp_global_memory + CAM_FRAME_BUFFER_SIZE;
  ...
  App_Context_Ptr->Preproc_ContextPtr->Resize_Dst_Img.pData = ai_fp_global_memory + CAM_FRAME_BUFFER_SIZE + RESIZE_OUTPUT_BUFFER_OFFSET;
   ...
   App_Context_Ptr->People_ContextPtr->nn_input_buffer = NULL;
  #else
   App_Context_Ptr->People_ContextPtr->nn_input_buffer = ai_fp_global_memory + CAM_FRAME_BUFFER_SIZE + AI_ACTIVATION_BUFFER_SIZE;
  #endif
 #endif
#else
...
void Run_Preprocessing(AppContext_TypeDef *App_Context_Ptr)
{
  ...
  PreprocCtxt_Ptr->Resize_Dst_Img.width=App_Context_Ptr->People_ContextPtr->nn_width;
  PreprocCtxt_Ptr->Resize_Dst_Img.height=App_Context_Ptr->People_ContextPtr->nn_height;
  ...
  PreprocCtxt_Ptr->Pfc_Src_Img.width=App_Context_Ptr->People_ContextPtr->nn_width;
  PreprocCtxt_Ptr->Pfc_Src_Img.height=App_Context_Ptr->People_ContextPtr->nn_height;
  ...
  PreprocCtxt_Ptr->Pfc_Dst_Img.width=App_Context_Ptr->People_ContextPtr->nn_width;
  PreprocCtxt_Ptr->Pfc_Dst_Img.height=App_Context_Ptr->People_ContextPtr->nn_height;
  PreprocCtxt_Ptr->Dma2dcfg.x=0;
  PreprocCtxt_Ptr->Dma2dcfg.y=0;
  PreprocCtxt_Ptr->Dma2dcfg.rowStride=App_Context_Ptr->People_ContextPtr->nn_width;
