...
#define UVC_FORMAT_INDEX_YUY2                         0x02U
#define UVC_FRAME_INDEX_VGA                           0x01U
#define UVC_FRAME_INDEX_QVGA                          0x02U
...
#define UVC_CONFIG_DESC_SIZ                           0x114U
...
#define VIDEO_IN_TERMINAL_DESC_SIZE                   0x12U
#define VIDEO_OUT_TERMINAL_DESC_SIZE                  0x09U

#define VC_FRAME_DESC_SIZE (VIDEO_VC_IF_HEADER_DESC_SIZE + \
                            VIDEO_IN_TERMINAL_DESC_SIZE + \
                            VIDEO_OUT_TERMINAL_DESC_SIZE)

#define VIDEO_VS_IF_IN_HEADER_DESC_SIZE               0x0FU
...
#define VS_HEADER_SIZE (VIDEO_VS_IF_IN_HEADER_DESC_SIZE + \
                        VS_FORMAT_MJPEG_DESC_SIZE + \
                        2 * VS_FRAME_DESC_SIZE + \
