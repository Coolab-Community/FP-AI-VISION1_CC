/**
  ...
  *             - image JPEG and YUV formats
  *             - VGA 640x480 and QVGA 320x240 frame resolutions
...
__ALIGN_BEGIN static uint8_t USBD_VIDEO_CfgHSDesc[] __ALIGN_END =
{
  ...
  DBVAL(UVC_MIN_BIT_RATE(UVC_FPS_HS_MJPEG_VGA)), /* dwMinBitRate: Minimum supported bit rate in bits/s  */
  DBVAL(UVC_MAX_BIT_RATE(UVC_FPS_HS_MJPEG_VGA)), /* dwMaxBitRate: Maximum supported bit rate in bits/s  */
  DBVAL(640 * 480 * 16 / 8),                     /* dwMaxVideoFrameBufSize: Maximum video frame size, in bytes */
  DBVAL(UVC_INTERVAL(UVC_FPS_HS_MJPEG_VGA)),     /* dwDefaultFrameInterval: following number of FPS */
  0x01,                                          /* bFrameIntervalType: Discrete frame interval type */
  DBVAL(UVC_INTERVAL(UVC_FPS_HS_MJPEG_VGA)),     /* dwMinFrameInterval: One supported value of interval (FPS) */
  ...
  0x02,                                          /* bmCapabilities: fixed frame rate supported */
  WBVAL(320),                                    /* wWidth: Image Frame Width */
  WBVAL(240),                                    /* wHeight: Image Frame Height */
  DBVAL(UVC_MIN_BIT_RATE(UVC_FPS_HS_MJPEG_QVGA)),/* dwMinBitRate: Minimum supported bit rate in bits/s  */
  DBVAL(UVC_MAX_BIT_RATE(UVC_FPS_HS_MJPEG_QVGA)),/* dwMaxBitRate: Maximum supported bit rate in bits/s  */
  DBVAL(320 * 240 * 16 / 8),                     /* dwMaxVideoFrameBufSize: Maximum video frame size, in bytes */
  DBVAL(UVC_INTERVAL(UVC_FPS_HS_MJPEG_QVGA)),    /* dwDefaultFrameInterval: following number of FPS */
  0x01,                                          /* bFrameIntervalType: Discrete frame interval type */
  DBVAL(UVC_INTERVAL(UVC_FPS_HS_MJPEG_QVGA)),    /* dwMinFrameInterval: One supported value of interval (FPS) */
  ...
  0x02,                                          /* bNumFrameDescriptor: 640x480 and 320x240 */
  DBVAL(UVC_GUID_YUY2),                          /* Giud Format: YUY2 {32595559-0000-0010-8000-00AA00389B71} */
  0x00, 0x00,
  0x10, 0x00,
  0x80, 0x00,
  0x00, 0xAA, 0x00, 0x38, 0x9B, 0x71,
  16U /* YUV2 */,                                /* bBitsPerPixel : Number of bits per pixel */
  ...
  WBVAL(640),                                    /* wWidth: Image Frame Width */
  WBVAL(480),                                    /* wHeight: Image Frame Height */
  DBVAL(UVC_MIN_BIT_RATE(UVC_FPS_HS_YUY2_VGA)),  /* dwMinBitRate: Minimum supported bit rate in bits/s  */
  DBVAL(UVC_MAX_BIT_RATE(UVC_FPS_HS_YUY2_VGA)),  /* dwMaxBitRate: Maximum supported bit rate in bits/s  */
  DBVAL(640 * 480 * 16 / 8),                     /* dwMaxVideoFrameBufSize: Maximum video frame size, in bytes */
  DBVAL(UVC_INTERVAL(UVC_FPS_HS_YUY2_VGA)),      /* dwDefaultFrameInterval: following number of FPS */
  0x01,                                          /* bFrameIntervalType: Discrete frame interval type */
  DBVAL(UVC_INTERVAL(UVC_FPS_HS_YUY2_VGA)),      /* dwMinFrameInterval: One supported value of interval (FPS) */
  ...
  WBVAL(320),                                    /* wWidth: Image Frame Width */
  WBVAL(240),                                    /* wHeight: Image Frame Height */
  DBVAL(UVC_MIN_BIT_RATE(UVC_FPS_HS_YUY2_QVGA)), /* dwMinBitRate: Minimum supported bit rate in bits/s  */
  DBVAL(UVC_MAX_BIT_RATE(UVC_FPS_HS_YUY2_QVGA)), /* dwMaxBitRate: Maximum supported bit rate in bits/s  */
  DBVAL(320 * 240 * 16 / 8),                     /* dwMaxVideoFrameBufSize: Maximum video frame size, in bytes */
  DBVAL(UVC_INTERVAL(UVC_FPS_HS_YUY2_QVGA)),     /* dwDefaultFrameInterval: following number of FPS */
  0x01,                                          /* bFrameIntervalType: Discrete frame interval type */
  DBVAL(UVC_INTERVAL(UVC_FPS_HS_YUY2_QVGA)),     /* dwMinFrameInterval: One supported value of interval (FPS) */
...
__ALIGN_BEGIN static uint8_t USBD_VIDEO_CfgFSDesc[] __ALIGN_END =
{
  ...
  WBVAL(640),                                    /* wWidth: Image Frame Width */
  WBVAL(480),                                    /* wHeight: Image Frame Height */
  DBVAL(UVC_MIN_BIT_RATE(UVC_FPS_FS_MJPEG_VGA)), /* dwMinBitRate: Minimum supported bit rate in bits/s  */
  DBVAL(UVC_MAX_BIT_RATE(UVC_FPS_FS_MJPEG_VGA)), /* dwMaxBitRate: Maximum supported bit rate in bits/s  */
  DBVAL(640 * 480 * 16 / 8),                     /* dwMaxVideoFrameBufSize: Maximum video frame size, in bytes */
  DBVAL(UVC_INTERVAL(UVC_FPS_FS_MJPEG_VGA)),     /* dwDefaultFrameInterval: following number of FPS */
  0x01,                                          /* bFrameIntervalType: Discrete frame interval type */
  DBVAL(UVC_INTERVAL(UVC_FPS_FS_MJPEG_VGA)),     /* dwMinFrameInterval: One supported value of interval (FPS) */
  ...
  WBVAL(320),                                    /* wWidth: Image Frame Width */
  WBVAL(240),                                    /* wHeight: Image Frame Height */
  DBVAL(UVC_MIN_BIT_RATE(UVC_FPS_FS_MJPEG_QVGA)),/* dwMinBitRate: Minimum supported bit rate in bits/s  */
  DBVAL(UVC_MAX_BIT_RATE(UVC_FPS_FS_MJPEG_QVGA)),/* dwMaxBitRate: Maximum supported bit rate in bits/s  */
  DBVAL(320 * 240 * 16 / 8),                     /* dwMaxVideoFrameBufSize: Maximum video frame size, in bytes */
  DBVAL(UVC_INTERVAL(UVC_FPS_FS_MJPEG_QVGA)),    /* dwDefaultFrameInterval: following number of FPS */
  0x01,                                          /* bFrameIntervalType: Discrete frame interval type */
  DBVAL(UVC_INTERVAL(UVC_FPS_FS_MJPEG_QVGA)),    /* dwMinFrameInterval: One supported value of interval (FPS) */
  ...
  WBVAL(640),                                    /* wWidth: Image Frame Width */
  WBVAL(480),                                    /* wHeight: Image Frame Height */
  DBVAL(UVC_MIN_BIT_RATE(UVC_FPS_FS_YUY2_VGA)),  /* dwMinBitRate: Minimum supported bit rate in bits/s  */
  DBVAL(UVC_MAX_BIT_RATE(UVC_FPS_FS_YUY2_VGA)),  /* dwMaxBitRate: Maximum supported bit rate in bits/s  */
  DBVAL(640 * 480 * 16 / 8),                     /* dwMaxVideoFrameBufSize: Maximum video frame size, in bytes */
  DBVAL(UVC_INTERVAL(UVC_FPS_FS_YUY2_VGA)),      /* dwDefaultFrameInterval: following number of FPS */
  0x01,                                          /* bFrameIntervalType: Discrete frame interval type */
  DBVAL(UVC_INTERVAL(UVC_FPS_FS_YUY2_VGA)),      /* dwMinFrameInterval: One supported value of interval (FPS) */
  ...
  WBVAL(320),                                    /* wWidth: Image Frame Width */
  WBVAL(240),                                    /* wHeight: Image Frame Height */
  DBVAL(UVC_MIN_BIT_RATE(UVC_FPS_FS_YUY2_QVGA)), /* dwMinBitRate: Minimum supported bit rate in bits/s  */
  DBVAL(UVC_MAX_BIT_RATE(UVC_FPS_FS_YUY2_QVGA)), /* dwMaxBitRate: Maximum supported bit rate in bits/s  */
  DBVAL(320 * 240 * 16 / 8),                     /* dwMaxVideoFrameBufSize: Maximum video frame size, in bytes */
  DBVAL(UVC_INTERVAL(UVC_FPS_FS_YUY2_QVGA)),     /* dwDefaultFrameInterval: following number of FPS */
  0x01,                                          /* bFrameIntervalType: Discrete frame interval type */
  DBVAL(UVC_INTERVAL(UVC_FPS_FS_YUY2_QVGA)),     /* dwMinFrameInterval: One supported value of interval (FPS) */
          ...
          if (pdev->dev_state == USBD_STATE_CONFIGURED)
          {
            if (req->wValue <= USBD_MAX_NUM_INTERFACES)
            {
              ...
              if (hVIDEO->interface == 1U)
              {
                ...
                ((USBD_VIDEO_ItfTypeDef *)pdev->pUserData)->Start();
                hVIDEO->uvc_state = UVC_PLAY_STATUS_READY;
              }
              else
              {
                /* Stop Streaming */
                ((USBD_VIDEO_ItfTypeDef *)pdev->pUserData)->Stop();
...
static uint8_t USBD_VIDEO_EP0_RxReady(USBD_HandleTypeDef *pdev)
{
  ...
  {
    /* Commit Request */
    ((USBD_VIDEO_ItfTypeDef *)pdev->pUserData)->Control(&video_Commit_Control);
  }
