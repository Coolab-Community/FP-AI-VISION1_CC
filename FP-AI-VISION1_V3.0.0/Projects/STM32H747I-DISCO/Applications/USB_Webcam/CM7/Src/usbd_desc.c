/**
  ...
  * @brief   his file implements the USB device descriptors.
  ******************************************************************************
  * @attention
  *
...
#define USBD_PID                      0x5780U
#define USBD_LANGID_STRING            0x409U
#define USBD_MANUFACTURER_STRING      "STMicroelectronics"
#define USBD_PRODUCT_STRING           "STM32 Webcam"
#define USBD_CONFIGURATION_STRING     "VIDEO Config"
#define USBD_INTERFACE_STRING         "VIDEO Interface"
...
USBD_DescriptorsTypeDef VIDEO_Desc =
{
  ...
  USBD_VIDEO_ConfigStrDescriptor,
  USBD_VIDEO_InterfaceStrDescriptor,
