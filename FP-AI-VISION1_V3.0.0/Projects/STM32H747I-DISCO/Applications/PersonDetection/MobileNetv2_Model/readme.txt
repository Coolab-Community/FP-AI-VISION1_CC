@page Image classification application: Person presence detection (quantized C model) 
...
The application consists in Person presence detection. The application identifies whether a person is present in the image or not.
The application is based on a medium complexity MobileNetV2 0.35 model. 

This application demonstrates how to make use of the C model generated by X-CUBE-AI v5.2.0 tool. 
...
The application has one configuration relying only on the MCU internal memory: 
...
@par Directory contents
  ...
  - Projects/STM32H747I-DISCO/Applications/PersonDetection/MobileNetv2_Model/CM7/Src/main.c                  Main program
  - Projects/STM32H747I-DISCO/Applications/PersonDetection/MobileNetv2_Model/CM7/Src/stm32h7xx_it.c          Interrupt handlers
  - Projects/STM32H747I-DISCO/Applications/PersonDetection/MobileNetv2_Model/CM7/Inc/stm32h7xx_hal_msp.c     HAL MSP for Cortex-M7 core
  - Projects/STM32H747I-DISCO/Applications/PersonDetection/MobileNetv2_Model/CM7/Inc/fp_vision_app.c         Application's parameters
  - Projects/STM32H747I-DISCO/Applications/PersonDetection/MobileNetv2_Model/CM7/Inc/network.c               Generated C model (neural network's topology)
  - Projects/STM32H747I-DISCO/Applications/PersonDetection/MobileNetv2_Model/CM7/Inc/network_data.c          Generated C model (neural network's weights and bias)
